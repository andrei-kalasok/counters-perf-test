 ...
 */
public class LongAdderCelledCounter {
	...
	public LongAdderCelledCounter(){
		this(10, 10, TimeUnit.SECONDS, Clock.defaultClock());
	}

	public LongAdderCelledCounter(int cellCount, long discreteness, TimeUnit timeUnit, Clock clock) {
	...
	private void tick() {
		...
		cellList.set(current++, rate.sumThenReset());
	}
}
